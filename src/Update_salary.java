...
public class Update_salary extends JFrame implements ActionListener,ItemListener{
    ...
    Update_salary(){
        ...
        l8.setBounds(20,250,100,20);
        t8.setBounds(120,250,200,20);
        add(l8);
        add(t8);
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        if(ae.getSource()==b1){
            ...
            String qry = "update salary set hra="+hra+",da="+da+",med="+med+",pf="+pf+",basic_salary="+basic+" ,No_of_working_days="+No_of_working_days+" where id="+c2.getSelectedItem();
        ...
        try{
           conn c1 = new conn();
            ...
            if(rs.next()){
                ...
                t8.setText(rs.getString("No_of_working_days"));
