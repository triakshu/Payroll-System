...
public class login extends JFrame implements ActionListener{
    ...
    login(){
        ...
        b1 = new JButton("login", new ImageIcon(ClassLoader.getSystemResource("icon\\login.png")));
        b2 = new JButton("Cancel", new ImageIcon(ClassLoader.getSystemResource("icon\\Cancel.png")));
        b3 = new JButton("Forgot password" ,new ImageIcon(ClassLoader.getSystemResource("icon\\EditOpen.png")));
